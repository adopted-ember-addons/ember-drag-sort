  ...
  <template>
    ...
    <div class="list-groups">
      ...
      <div class="list-group-wrapper">
        ...
        <p>
          Use `determineForeignPositionAction` to prevent user from rearranging
          a list, while still letting them drag in and out of the list
        </p>
      ...
      <div class="list-group-wrapper">
        ...
        <p>
          This example is similar to the previous one, except that the source
          list remains absolutely static.
        </p>
      ...
      <div class="list-group-wrapper">
        ...
        <p>
          ...
          semantics are very restrictive. To work around this problem,
          top/bottom padding on table cells can be used instead of selectors.
        </p>
      ...
      <div class="list-group-wrapper">
        ...
        <p>
          Set `isHorizontal=true` for a horizontal drag n drop. You can also
          drag between a horizontal list and a vertical.
        </p>
      ...
      <div class="list-group-wrapper">
        ...
        <p>
          Use `isRtl=true` if you're using a language which is read right to
          left. Has no effect on vertical lists.
        </p>
